    ...
    evaluateGame = () => {
        ...
        if (userChoice === gameChoice) {
            ...
            if (gameChoice === 'SCISSORS') {
                ...
                this.setState(prevState => ({
                    gameStatus: gameStatusConstants.loss,
                    score: prevState.score - 1,
                }))
            }
            ...
            <GameResultViewContainer>
                <SelectedOptionsContainer>
                    <GameUserOptionContainer>
                        ...
                        <GameParticipantChoiceImage src={userChoiceObject.image} alt="your choice" />
                    </GameUserOptionContainer>
                    <GameUserOptionContainer>
                        <GameParticipantText>Other</GameParticipantText>
                        <GameParticipantChoiceImage src={gameChoiceObject.image} alt="opponent choice" />
                    </GameUserOptionContainer>
                </SelectedOptionsContainer>
        ...
        render() {
            ...
            return (
                <AppContainer>
                    ...
                    <PopupContainer>
                        <Popup
                            modal trigger{<TriggerButton type="button">Rules</TriggerButton>} closeOnEscape window
                        >
                            {close => (
                                <PopUpBody>
                                    <PopUpImage src="https://assets.ccbp.in/frontend/react-js/rock-paper-scissor/rules-image.png" alt="rules" />
